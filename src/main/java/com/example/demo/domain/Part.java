...
public abstract class Part implements Serializable {
    ...
    double price;
    @Min(value = 0, message = "Inventory value must be positive and less than Maximum Inventory")
    int inv;
    ...
    public boolean isValidInv(int inv){
        if  (inv >= minInv && inv <= maxInv) return true;
        return false;
    }
